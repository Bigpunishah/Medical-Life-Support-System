...
public class Menu {
    ...
    public void patientSelection() {
        ...
        switch (i) {
            ...
            case 2:
                ...
                System.out.println(patient.getPatient(name));
                System.out.println("________________________________________________________________");
                break;
    ...
    public void employeeSelection() {
        ...
        switch (i) {
            ...
            case 2:
                ...
                System.out.println(medicalEmployee.getEmployee(employeeId));
                System.out.println("________________________________________________________________");
                break;
    ...
    public void medicineSelection() {
        ...
        System.out.println("Medcine Selection: \n1.) Get Medicine By Name \n2.) Get Medicine By ID");
        int i = sc.nextInt();
        switch (i) {
            case 1:
                System.out.println("Enter name of medicine: ");
                System.out.println(medicine.getMedicineByName(sc.nextLine()));
                System.out.println("________________________________________________________________");
                break;

            case 2:
                System.out.println("Enter ID of medicine: ");
                System.out.println(medicine.getMedicineById(sc.nextLine()));
                System.out.println("________________________________________________________________");
                break;
